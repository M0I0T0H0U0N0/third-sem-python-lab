#Develop a Tkinter based python program to perform arithmetic operations
#add,subtract.mul and div of two numbers. The numbers should be read using two different
#text fields and there should be four separate buttons for performing each operation. On
#clicking the button, the result should be displayed in a separate messagedialog box
